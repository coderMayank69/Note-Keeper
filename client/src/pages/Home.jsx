    ...
    <>
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-t from-purple-900/30 via-transparent to-transparent z-10" /> */}
        ...
        <button
          ...
          className="flex items-center gap-4 px-16 py-16 bg-gray-100 text-gray-200 rounded hover:bg-gray-900 transition font-semibold shadow bg-opacity-90 z-20"
        >
        ...
        <button onClick={() => navigate('/notes')} className="mt-6 px-8 py-4 bg-gray-100 text-gray-200 rounded hover:bg-gray-900 transition font-semibold shadow bg-opacity-90 z-20"> 
          Notes
        </button>
      </div>
